...
function SHjobcards() {
    ...
    return (
        <div>
            ...
            <SearchBar jobs={jobs} alljobs={alljobs} setJobs={setJobs} setAlljobs={setAlljobs} />
                                            ...
                                            <div className="row g-4">
                                                <div className="col-sm-12 col-md-8 d-flex align-items-center">
                                                    ...
                                                    <div className="text-start ps-4">
                                                        <h5 className="mb-5">
                                                            {job.title}
                                                            <span  style={{ fontWeight: 'lighter',fontFamily:'sans-serif',color:"GrayText"}}> | {job.jmid.orgName}</span>
                                                        </h5>
